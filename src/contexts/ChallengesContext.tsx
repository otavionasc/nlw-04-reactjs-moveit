...
// ...rest = Operador em javascript que indica que está pegando o restante das propriedades
export function ChallengesProvider({ children, ...rest }: ChallengesProviderProps) {
  ...
  // Armazenamento nos cookies do browser
  useEffect(() => {
  ...
  function completeChallenge() {
    ...
    // variável let = let it change (deixe isso mudar). Ela pode receber um novo valor no futuro.
